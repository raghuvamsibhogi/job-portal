...
export const addProducttrunk = createAsyncThunk("/admin/products/addProduct",
    async (formData)=>{
        const response = await axios.post("http://localhost:5000/api/admin/products/add-product"
            ,formData
            ,
            {
                headers:{
...
export const editProducttrunk = createAsyncThunk("/admin/products/updateProduct",
    async ({id,formData})=>{
        const response = await axios.put(`http://localhost:5000/api/admin/products/update-product/${id}`
            ,formData
            ,
            {
                headers:{
