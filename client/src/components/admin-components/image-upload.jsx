...
function ProductUploadImage({
    file,setFile,uploadedUrl,SetUploadedUrl,setImageLoadingState,imageloadingState,isEditMode,isCustomStyling=false
}){
    ...
    async function uploadImageToCloudinary(){
        ...
        const imageResult = await axios.post(`${import.meta.env.VITE_API_URL}/api/admin/products/upload-image`,imageFormData) 
