...
export const getOrders = createAsyncThunk('./order/getOrders',async(userId)=>{
    const response = await axios.get("http://localhost:5000/api/shop/orders/getOrders",
      { params: { userId } } 
    ) 
    return response.data
}
...
export const getOrderDetails = createAsyncThunk('./order/getOrderDetails',async(orderId)=>{
  console.log(orderId)
    const response = await axios.get("http://localhost:5000/api/shop/orders/getOrderDetails",
      { params: { orderId } } 
    ) 
    return response.data
}
